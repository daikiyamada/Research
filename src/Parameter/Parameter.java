...
public class Parameter {
    ...
    public int k =3;
    /**実験パラメータ*/
    public String [] graph_List = {"nws_0.5_","Lattice_","Sinet_","Germany50_","Pioro_","CER_"};
    public int [] graph_list = {1,2,3,5,6,4};
    ...
    public int[] x_dis = {3,4};
    public int[] y_cos = {3,4};
    public int[] z_cap = {3,4};

    /*public String [] graph_List = {"sinet_"};
    public int [] graph_list = {6};
    ...
    public String path1 = "C:\\Users\\Daiki Yamada\\Google ドライブ\\実験結果\\実験_1121\\";
